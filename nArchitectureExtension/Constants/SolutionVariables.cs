namespace nArchitectureExtension.Constants
{
    public static class SolutionVariables
    {
        ...
        public static string CoreCrossCuttingConcernsProjectName => "Core.CrossCuttingConcerns";
        public static string CoreElasticSearchProjectName => "Core.ElasticSearch";
